...
const EmployeeLayout = ({ children }) => {
  ...
  const menuItems = [
    { path: '/employee', icon: User, label: 'Dashboard', gradient: 'gradient-primary' },
    { path: '/employee/create-invoice', icon: Receipt, label: 'Create Invoice', gradient: 'gradient-success' },
    { path: '/employee/customers', icon: Users, label: 'Customers', gradient: 'gradient-secondary' },
    { path: '/employee/products', icon: Package, label: 'Products', gradient: 'gradient-warning' },
    { path: '/employee/invoices', icon: List, label: 'Invoice List', gradient: 'gradient-info' },
    { path: '/employee/payments', icon: CreditCard, label: 'Payments', gradient: 'gradient-danger' },
  ];
        ...
        <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-purple-600 to-blue-600">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">Daily Operations</p>
            </div>
          </div>
        </div>
